...
export default function ModalAgregarAlumno({ onClose, onAlumnoAgregado }) {
    const [form, setForm] = useState({
        nombre: "", apellido: "", email: "",
        telefono: "", edad: "", sucursal: "Moreno",
    });
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 w-full max-w-md mx-4">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-white font-semibold text-lg">Agregar alumno</h2>
